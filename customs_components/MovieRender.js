...
import { addMovieToList, getUserLists } from "../store/actions/lists";
...
export const MovieRender = (props) => {
  ...
  return (
    <View style={{ height: "auto", backgroundColor: Colors.primary }}>
      <View style={{margin: 10, backgroundColor:"white", borderRadius: 10}}>
        ...
        <View style={styles.gridItem}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
            <Ionicons name="film" size={20} color="black" />
          ...
          /> : null}
            ...
            <View style={{ backgroundColor: endorsedButtonColor, width: "100%" }}>
              <Button
                color="white"
                title={endorseRec}
                onPress={endorse}
